...
TEST_SUITE("MatrixBlocks") {
  TEST_CASE("Eigen::MatrixXd zero_row_col" *
            doctest::description("zero_row_col")) {
  ...
  TEST_CASE("Eigen::MatrixXd swap_left_right_blocks" *
  ...
  TEST_CASE("Eigen::MatrixXd tridiagonal" *
            doctest::description("tridiagonal")) {
