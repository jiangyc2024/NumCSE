...
//! \brief Compute the solution to the nonlinear system by using Newtons
//! iteration \param[in] alpha \param[in] beta parameters \param[in] Uin input
//! voltages \param[out] Uout output voltages
/* SAM_LISTING_BEGIN_0 */
