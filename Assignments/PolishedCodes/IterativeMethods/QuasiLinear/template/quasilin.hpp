...
Eigen::VectorXd fixed_point_step(const Eigen::VectorXd &xk, const Eigen::VectorXd &b) {
  ...
  // TODO: (9-10.b) implement one step of the fixed point iteration
  // START
...
Eigen::VectorXd solveQuasiLinSystem(double rtol, double atol, Eigen::VectorXd &b) {
  ...
  Eigen::VectorXd x = b;
  // TODO: (9-10.c) apply the iterative method fixed_point_step to solve
...
Eigen::VectorXd newton_step(const Eigen::VectorXd &x, const Eigen::VectorXd &b) {
  Eigen::VectorXd x_new = Eigen::VectorXd::Zero(b.size());
  // TODO: (9-10.f) implement one Newton step exploiting the
...
Eigen::VectorXd solveQLSystem_Newton(double rtol, double atol, Eigen::VectorXd &b) {
  ...
  Eigen::VectorXd x = b;
  // TODO: (9-10.c) apply the iterative method newton_step to solve
  // the quasi-linear system
  // START
