...
TEST_SUITE("SymRankOneApprox") {
  ...
  TEST_CASE("Eigen::VectorXd symmRankOneApprox" *
    ...
    Eigen::VectorXd z_approx(3);
    z_approx << 1.16657, 0.441537, 0.859084;

    Eigen::VectorXd stud = symmRankOneApprox_TEST(MM, rtol, atol);
