...
std::pair<Eigen::Vector2d, Eigen::Matrix2d> PhiAndW(double u0, double v0,
  ...
  // TO DO: (11-7.f)  Calculate the time evolution of Phi(t,y0) and W(t,y0)
 ...
 */
/* SAM_LISTING_BEGIN_2 */
Eigen::Vector2d findInitCond() {
  Eigen::Vector2d y;
  // TO DO: (11-7.g) Use Newton's method with initial guess (3,2) to find a
  ...
  // TO DO: (11-7.g) Calculate the evolution of the Lotka-Volterra ODE up to
