...
Eigen::MatrixXd strassenMatMult(const Eigen::MatrixXd &A,
  ...
  Eigen::MatrixXd A22 = A.bottomRightCorner(n / 2, n / 2);

  Eigen::MatrixXd B11 = B.topLeftCorner(n / 2, n / 2);
  Eigen::MatrixXd B12 = B.topRightCorner(n / 2, n / 2);
  Eigen::MatrixXd B21 = B.bottomLeftCorner(n / 2, n / 2);
  Eigen::MatrixXd B22 = B.bottomRightCorner(n / 2, n / 2);
...
double test_strassen() {
  ...
  Eigen::MatrixXd AB = strassenMatMult(A, B);
  // Eigen Matrix multiplication
  Eigen::MatrixXd AxB = A * B;
