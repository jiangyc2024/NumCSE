...
t.duration();
  ...
  on \CppRefDoc{chrono/high_resolution_clock}.
    ...
    \begin{writeverbatim}{prbfile}
      \begin{samsolution}
        ...
        \begin{samcode}[C++11-code]{cpp:arrowmat_timing}
          ...
          \samincludecpp{\codes/MatVec/ArrowMatrix/solutions/arrowmatvec.cpp}[3]
        \end{samcode}

        \samplot{\codes/MatVec/ArrowMatrix/arrowmatvec_comparison.eps}
