...
You can use Eigen block operations, see  \EigenDoc{group__TutorialBlockOperations.html}{here}.
...
void kron_reshape(const MatrixXd & A, const MatrixXd & B,
               const VectorXd & x, VectorXd & y);
  \end{lstlisting}
  Study \lref{rem:eigrs} about ``reshaping'' matrices in \eigen{}. See also the Eigen
  documentation \EigenDoc{group__TutorialMapClass.html}{here}.
