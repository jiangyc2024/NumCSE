# Problem 13-2: Semi-implicit Runge-Kutta SSM
...
> Open `rosenbrock.hpp` and fill in the missing code in between the delimiters `// START` and `// END` according to the instructions preceded by `// TO DO:`.
