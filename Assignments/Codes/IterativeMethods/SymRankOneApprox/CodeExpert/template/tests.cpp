...
TEST_SUITE("SymRankOneApprox") {
  TEST_CASE("VectorXd symRankOneBestApproxSym" * doctest::description("approximation of Frobenius norm for a symmetric matrix")) {
  ...
  TEST_CASE("VectorXd symmRankOneApprox" * doctest::description("approximation of Frobenius norm using the Gauss-Newton iteration")) {
    MatrixXd MM(3, 3);
