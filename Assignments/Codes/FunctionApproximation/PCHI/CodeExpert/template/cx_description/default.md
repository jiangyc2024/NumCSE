# Problem 7-7: Piecewise cubice Hermite Interpolation of Functions
...
> Open `pchi.hpp` and fill in the missing code in between the delimiters `// START` and `// END` according to the instructions preceded by `// TO DO:`.
