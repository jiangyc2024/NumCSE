# Problem 8-3: Numerical integration of improper integrals
...
> Open `quadinf.hpp` and fill in the missing code in between the delimiters `// START` and `// END` according to the instructions preceded by `// TO DO:`.
