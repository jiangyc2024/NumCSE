...
int main() {
  std::cout << "\nEnter \"0\" to test all functions.\n"
            ...
            << "Enter \"2\" to only test cvgrateEquidistantMesh().\n"
            << "Enter \"3\" to only test testcvgEquidistantMesh().\n"
            << "Enter \"4\" to only test cvgrateGradedMesh().\n"
            << "Enter \"5\" to only test testcvgGradedMesh().\n"
            << "\n";
