...
/* SAM_LISTING_BEGIN_0 */
inline void freqfilter(const VectorXd &y, int k, VectorXd &low, VectorXd &high) {
  ...
  const VectorXcd c = fft.fwd(y); // Perform DFT of input vector
