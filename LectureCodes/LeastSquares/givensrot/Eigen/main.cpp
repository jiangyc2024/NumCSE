...
int main () {
	...
	std::cout << "aIn=\n" << aIn << std::endl << "Q=\n" << Q1 << std::endl << "aOut=\n" << r1 << std::endl;
	std::cout << "Error norm (Q'Q-I) = " << (Q1.transpose() * Q1 - Eigen::MatrixXd::Identity(n,n)).norm() << std::endl;
	...
	qrgivens(AIn, Q2, R2);
	std::cout << "AIn=\n" << AIn << std::endl << "Q=\n" << Q2 << std::endl << "R=\n" << R2 << std::endl;
	std::cout << "Error norm (Q'Q-I) = " <<  (Q2.transpose() * Q2 - Eigen::MatrixXd::Identity(n,n)).norm() << std::endl;
